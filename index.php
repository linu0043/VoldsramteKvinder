...
<?php @include "./resources/templates/header.php"; ?>
    <main>
        <div class="siteContainer">
            <article>
                <h3>VoldsramteKvinder.dk – Et godt liv, på trods af volden.</h3>
                <hr>
                <section>
                <p>Landsorganisationen for Voldsramte Kvinder og Børn, er en forening af frivillig, der siden 2009 har ydet gratis og anonym hjælper, støtter og vejleder til voldsramte kvinder.</p>
